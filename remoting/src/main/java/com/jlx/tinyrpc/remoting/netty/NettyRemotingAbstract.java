...
import com.jlx.tinyrpc.remoting.ChannelEventListener;
import com.jlx.tinyrpc.remoting.InvokeCallback;
import com.jlx.tinyrpc.remoting.RPCHook;
import com.jlx.tinyrpc.remoting.common.Pair;
import com.jlx.tinyrpc.remoting.common.RemotingHelper;
import com.jlx.tinyrpc.remoting.common.SemaphoreReleaseOnlyOnce;
import com.jlx.tinyrpc.remoting.common.ServiceThread;
...
import com.jlx.tinyrpc.remoting.protocol.RemotingSysResponseCode;
...
public abstract class NettyRemotingAbstract {
     ...
     * 在回调线程池中执行回调；如果回调线程池是空，则在当前线程中执行回调
     */
    ...
    /**
     * 含有一个线程的线程池，用来执行ChannelEventListener监听的事件
     */
